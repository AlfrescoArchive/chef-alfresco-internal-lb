...
if install_haproxy_discovery
  template node['internal_lb']['ec2']['discovery_chef_erb']['dest'] do
    source node['internal_lb']['ec2']['discovery_chef_erb']['source']
  end
  template node['internal_lb']['ec2']['discovery_chef_json']['dest'] do
    source node['internal_lb']['ec2']['discovery_chef_json']['source']
  end
end
